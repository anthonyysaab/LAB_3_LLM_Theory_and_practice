...
Merged local sources on 2026-06-03:
...
The following local files were already present in the uploaded repository with matching SHA-256 hashes:

- First experiment scripts and PDFs: `train_model.py`, `corpus_cleaning_script.py`, `Read_corpus_script.py`, `Fetch_poetry_corpus.txt`, `lab3.pdf`
- First experiment useful files: corpus files, `training_log.csv`, `vocab.pkl`, `training_samples.txt`, `final_sample.txt`
- Experiment II files: `train_model_II.py`, `import_requests_II.py`, report PDF, 60MB artifact files, 60MB samples, dataset link

## Added During Merge

- `cuda_availability.py` from `C:\Users\user\Python\lab3`
- `plots/char_gpt_loss_curves model 2.html` from `C:\Users\user\Python\lab3\plots`
- `Experiment II/bad_rows_log.tsv` from `C:\Users\user\Python\lab3 Experiment II`
